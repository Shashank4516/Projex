/** Stroke icons aligned with minimalist login reference (grey outlines). */
...
export function IconEnvelope({ className }) {
  return (
    ...
    >
      <path
        d="M4 18h16a2 2 0 002-2V8l-10 7L2 8v8a2 2 0 002 2z"
        stroke="currentColor"
        strokeWidth="1.5"
...
export function IconUser({ className }) {
  return (
    ...
    >
      ...
      <path
        d="M18.5 20.25c-.7-4-3.72-6-6.5-6s-5.8 2-6.5 6"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
export function IconPin({ className }) {
  return (
    ...
    >
      <path
        d="M12 21s7-5.327 7-11a7 7 0 10-14 0c0 5.673 7 11 7 11z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
...
export function LogoApple({ className }) {
  return (
    <svg
      className={className}
      width={22}
